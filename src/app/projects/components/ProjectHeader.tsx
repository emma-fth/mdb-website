...
export default function ProjectHeader() {
  ...
  const animationClass = shouldReduceAnimations ? 'animate-fade-in-up-mobile' : 'animate-fade-in-up'
  const delay1 = shouldReduceAnimations ? '0.2s' : '0.4s'
    ...
    <section className="min-h-screen w-screen bg-gradient-to-b from-[#D1DFF2] to-white flex items-center -mt-20 relative mb-0 py-4 sm:py-6 md:py-8 lg:py-12 xl:py-16">
      ...
      <div className="w-full px-3 sm:px-4 py-4 sm:py-6 md:py-8 pt-16 sm:pt-20 md:pt-24 lg:pt-28 relative z-10">
        <div className="container mx-auto text-center">
          <h1 className={`text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-patua-one text-blue-900 mb-4 sm:mb-6 md:mb-8 ${animationClass}`} style={{ animationDelay: delay1 }}>
            PROJECTS
          </h1>
