...
export default function Clients({ client, className = '' }: ClientsProps) {
  return (
    <div className={`bg-white/40 backdrop-blur-xl backdrop-saturate-150 border border-white/20 rounded-xl shadow-lg p-8 hover:shadow-xl hover:scale-110 hover:translate-x-1 transition-all duration-300 transform hover:drop-shadow-xl origin-center ${className}`}>
